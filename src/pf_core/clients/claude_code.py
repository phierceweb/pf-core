...
class ClaudeCodeClient:
    ...
    Args:
        ...
        extra_args: Additional CLI flags inserted before ``--print``
    ...
    def chat(
        ...
        **kwargs: Any,
        ...
        cmd = [binary_path, *self.extra_args, *model_flag, "--print"]
...
def get_client(
    *,
    ...
    / ``extra_args`` / ``retry``. Use :func:`reset_client` to drop all
    cached instances (useful for testing), or :func:`new_client` for a
    fresh, independently-configured instance.
    """
