...
Promoted from a consumer document-extraction pipeline. Generic
image-dedup machinery — used there for stripping repeated page-header
refs across PDF chapters. Available in any consumer via the optional
``[image-phash]`` extra.
