...
LLMs are unreliable at calendar arithmetic. When an article published on Wednesday 2026-04-15 says "the president on Tuesday signed the order," asking the LLM to emit `2026-04-14` directly produces wrong dates a meaningful fraction of the time — wrong year, wrong week, sometimes wrong day-of-week.
