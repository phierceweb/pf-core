...
| Substack posts | `/p/real-slug-from-actual-post` | `/p/<topic>-<date>` invented from event description |
...
|---|---|
| URLs to cite | Real search API (`pf_core.clients.brave`) or curated newsletter inline links |
