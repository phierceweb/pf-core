...
class TestCanonicalUrl:
    ...
    def test_utm_params_stripped(self):
        assert canonical_url(
            "https://example.com/x?utm_source=substack&utm_medium=email&utm_campaign=newsletter"
        ) == "https://example.com/x"
    ...
    def test_newsletter_style_substack_url_canonicalizes(self):
        # A real-world shape of how newsletter links arrive: AP URL with Substack
        # utm markers and sometimes a fragment.
        raw = (
            "https://apnews.com/article/city-council-approves-budget-"
            "a1b2c3d4?utm_source=substack&utm_medium=email"
    ...
    def test_cross_tracking_variants_match(self):
        ...
        newsletter = "https://apnews.com/article/foo?utm_source=substack"
